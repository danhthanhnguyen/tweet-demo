...
<body>
    <nav class="navbar navbar-light navbar-expand-md">
        <div class="container">
            <div class="navbar-brand"><a href="{{ route('home') }}"><span class="text-primary d-flex align-items-center"><svg version="1.1" id="Layer_1" width="30" height="30" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
           ...
           <g></svg></span></a></div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item pr-2 pl-2"><a href="{{ route('home') }}" class="nav-link text-light">Home</a></li>
                    <li class="nav-item pr-2 pl-2"><a href="{{ route('user', ['user' => Auth::user()->name]) }}" class="nav-link text-light">Profile</a></li>
                </ul>
                <a href="{{ route('logout') }}" class="btn btn-light action-button text-light btn-control" role="button"><span class="navbar-text actions text-white">Log out</span></a>
            </div>
        </div>
    </nav>
    <main class="main mt-2">
        @yield('content')
        <div class="up-arrow d-flex align-items-center">
            <svg class="up-arrow-to-top" version="1.1" id="Capa_1" width="42" height="42" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 490.667 490.667" style="enable-background:new 0 0 490.667 490.667;" xml:space="preserve">
                <path style="fill:rgba(9,20,154,0.74);" d="M245.333,0C109.839,0,0,109.839,0,245.333s109.839,245.333,245.333,245.333
    ...
    <footer class="footer">
        <div class="container">
            <span class="text-secondary">Copyright &copy <script>document.write(new Date().getFullYear())</script>, Tweet</span>
        </div>
    </footer>
