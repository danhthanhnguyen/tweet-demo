...
Route::get('/password/forgot', [ResetPasswordController::class, 'index'])->name('password.request');
Route::post('/password/forgot', [ResetPasswordController::class, 'store'])->name('password.email');
Route::get('/password/reset/{token}', [ResetPasswordController::class, 'requests'])->name('password.reset');
